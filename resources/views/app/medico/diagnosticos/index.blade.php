                ...
                <table class="border-collapse border border-slate-700 ...">
                    ...
                    <tbody>
                        @foreach($diagnosticos as $diagnostico)
                            <tr>
                            <td class="border border-slate-700 ...">{{ $diagnostico->paciente->nombre_completo() }}</td>
                            <td class="border border-slate-700 ...">{{ $diagnostico->enfermedad->nombre }}</td>
                            <td class="border border-slate-700 ...">{{ $diagnostico->prueba->nombre }}</td>
                            <td class="border border-slate-700 ...">{{ $diagnostico->cita->fecha ?? 'Te falta la relación con paciente' }}</td>
                            <td class="border border-slate-700 ...">{{ $diagnostico->resultado_de_la_prueba }}</td>
                            <td>
