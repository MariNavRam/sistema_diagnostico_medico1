            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col justify-center items-center">
                @if($tratamientos == null)
                    <h4 class="font-semibold text-xl text-gray-300 dark:text-gray-200 leading-tight">
                        No fue posible determinar la enfermedad que padece {{$paciente->nombre_completo()}}.
                    </h4>
                ...
                @else
                    <h4 class="font-semibold text-xl text-gray-300 dark:text-gray-200 leading-tight">
                        En base a los parámetros ingresados, se determina que la enfermedad que padece {{$paciente->nombre_completo()}} es:
                    </h4>
                    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                        {{$enfermedad->nombre}}
                    </h2>
