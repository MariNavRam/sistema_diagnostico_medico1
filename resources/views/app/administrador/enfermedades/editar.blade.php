        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col justify-center items-center">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="w-full max-w-xs">
                    ...
                    action="{{ route('ActualizarEnfermedad') }}" method="POST">
                        @csrf
                        <div class="mb-9">
                        <input type="hidden" id="id" name="id" value="{{$enfermedad->id}}">
                        ...
                        <div class="mb-9">
                            ...
                            <input id="enfermedad" name="enfermedad" type="text" value="{{ $enfermedad->nombre }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline form-control">
                        </div>
