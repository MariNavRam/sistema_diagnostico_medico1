            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <table class="border-collapse border border-slate-700 ...">
                    <thead>
                        ...
                        <th class="border border-slate-700 ...">Posibles Causas</th>
                        <th>Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach($enfermedades as $enfermedad)
                        <tr>
                        <td class="border border-slate-700 ...">{{ $enfermedad->nombre }}</td>
                        <td class="border border-slate-700 ...">{{ $enfermedad->causa }}</td>
                        <td>
                            <a type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-1 py-0.5 text-center mr-2 mb-2 " href="{{route('EditarEnfermedad',Crypt::encrypt($enfermedad->id))}}">Editar</a>
                        </td>
                        </tr>
                    @endforeach
                    </tbody>
